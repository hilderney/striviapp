...
class LlmSummarizerBuilder {
  constructor() {
    ...
    this._logsDir = './logs';
    this._stagingDir = process.env.STAGING_DIR || './staging';
  ...
  // Uploads e arquivos de entrada precisam de path explícito no desktop:
  // paths relativos quebram dentro do pacote Electron.
  ...
  getConfig() {
    return {
      ...
      stagingDir: path.resolve(this._stagingDir),
